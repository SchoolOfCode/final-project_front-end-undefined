...
const List = ({ places, contentLoading, setIsCard, setCardData, setRating, rating, reviewData, starRating, setStarRating, setFavStatus, favStatus, setAverageRating, averageRating}) => {
